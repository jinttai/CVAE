"""
Main execution script for DDP trajectory optimization.
"""
...
def main():
    ...
    results_path = os.path.join(save_dir, "results.pt")
    torch.save({
        'states': states.cpu(),
    ...
    plt.title('DDP Cost History', fontsize=14)
    plt.grid(True, alpha=0.3)
    plt.yscale('log')
    
    cost_history_path = os.path.join(save_dir, "cost_history.png")
    ...
    plt.tight_layout()
    trajectory_path = os.path.join(save_dir, "trajectory.png")
